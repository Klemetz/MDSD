...
public interface BuisnessLogicLayerPackage extends EPackage {
	...
	/**
	 * Returns the meta object for the '{@link RootElement.BuisnessLogicLayer.PaymentHandler#makePayment(RootElement.BuisnessLogicLayer.PaymentInfo, RootElement.Buissnesslayer.Booking) <em>Make Payment</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the '<em>Make Payment</em>' operation.
	 * @see RootElement.BuisnessLogicLayer.PaymentHandler#makePayment(RootElement.BuisnessLogicLayer.PaymentInfo, RootElement.Buissnesslayer.Booking)
	 * @generated
	 */
