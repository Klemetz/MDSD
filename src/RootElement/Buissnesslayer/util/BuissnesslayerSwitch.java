 ...
 * @generated
 */
public class BuissnesslayerSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case BuissnesslayerPackage.ROOM: {
			...
			case BuissnesslayerPackage._ABSTRACT_USER: {
				_AbstractUser _AbstractUser = (_AbstractUser)theEObject;
				T result = case_AbstractUser(_AbstractUser);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public T case_AbstractUser(_AbstractUser object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>User Handler</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>User Handler</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseUserHandler(UserHandler object) {
		return null;
	}
