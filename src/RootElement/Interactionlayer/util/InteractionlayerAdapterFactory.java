/**
 */
package RootElement.Interactionlayer.util;

import RootElement.Interactionlayer.*;
 ...
 * <!-- end-user-doc -->
 * @see RootElement.Interactionlayer.InteractionlayerPackage
 * @generated
 */
public class InteractionlayerAdapterFactory extends AdapterFactoryImpl {
	...
	/**
	 * Creates a new adapter for an object of class '{@link RootElement.Interactionlayer.GUI <em>GUI</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link RootElement.Interactionlayer.GUIController <em>GUI Controller</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link RootElement.Interactionlayer.LoginController <em>Login Controller</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link RootElement.Interactionlayer.LoginController_DataType1 <em>Login Controller Data Type1</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
