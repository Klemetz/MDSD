...
public class BuisnessLogicLayerPackageImpl extends EPackageImpl implements BuisnessLogicLayerPackage {
	 ...
	 * @generated
	 */
	public EOperation getPaymentHandler__PaymentInfomakePaymentPaymentInfopaymentInfoBookingbooking() {
	...
	public void createPackageContents() {
		...
		createEOperation(paymentHandlerEClass, PAYMENT_HANDLER___PAYMENT_INFOMAKE_PAYMENT_PAYMENT_INFOPAYMENT_INFO_BOOKINGBOOKING);
	}
	...
	public void initializePackageContents() {
		...
		initEOperation(getPaymentHandler__PaymentInfomakePaymentPaymentInfopaymentInfoBookingbooking(), null, "PaymentInfomakePaymentPaymentInfopaymentInfoBookingbooking", 1, 1, IS_UNIQUE, !IS_ORDERED);
	...
	protected void createUMLAnnotations() {
		...
		addAnnotation
		  (getPaymentHandler__PaymentInfomakePaymentPaymentInfopaymentInfoBookingbooking(), 
		   source, 
		   new String[] {
			 "originalName", "PaymentInfo makePayment(PaymentInfo paymentInfo, Booking booking)"
		   });
	}
