 ...
 * </p>
 * <ul>
 *   <li>{@link RootElement.Buissnesslayer.impl.BookingImpl#getBookingID <em>Booking ID</em>}</li>
 *   <li>{@link RootElement.Buissnesslayer.impl.BookingImpl#getGuest <em>Guest</em>}</li>
 *   <li>{@link RootElement.Buissnesslayer.impl.BookingImpl#getNrOfGuests <em>Nr Of Guests</em>}</li>
 *   <li>{@link RootElement.Buissnesslayer.impl.BookingImpl#getStartDate <em>Start Date</em>}</li>
 *   <li>{@link RootElement.Buissnesslayer.impl.BookingImpl#getEndDate <em>End Date</em>}</li>
 *   <li>{@link RootElement.Buissnesslayer.impl.BookingImpl#getExtras <em>Extras</em>}</li>
 *   <li>{@link RootElement.Buissnesslayer.impl.BookingImpl#getParkings <em>Parkings</em>}</li>
 *   <li>{@link RootElement.Buissnesslayer.impl.BookingImpl#getRooms <em>Rooms</em>}</li>
 *   <li>{@link RootElement.Buissnesslayer.impl.BookingImpl#isCheckedIn <em>Checked In</em>}</li>
 *   <li>{@link RootElement.Buissnesslayer.impl.BookingImpl#isCheckedOut <em>Checked Out</em>}</li>
 *   <li>{@link RootElement.Buissnesslayer.impl.BookingImpl#getPayment <em>Payment</em>}</li>
 *   <li>{@link RootElement.Buissnesslayer.impl.BookingImpl#isPaymentComplete <em>Payment Complete</em>}</li>
 *   <li>{@link RootElement.Buissnesslayer.impl.BookingImpl#getRoom <em>Room</em>}</li>
 * </ul>
 *
 * @generated
 */
