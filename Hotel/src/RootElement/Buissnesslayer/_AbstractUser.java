 ...
 * </p>
 * <ul>
 *   <li>{@link RootElement.Buissnesslayer._AbstractUser#getName <em>Name</em>}</li>
 *   <li>{@link RootElement.Buissnesslayer._AbstractUser#getEmail <em>Email</em>}</li>
 *   <li>{@link RootElement.Buissnesslayer._AbstractUser#getBookingHandler <em>Booking Handler</em>}</li>
 *   <li>{@link RootElement.Buissnesslayer._AbstractUser#getLogincontroller <em>Logincontroller</em>}</li>
 *   <li>{@link RootElement.Buissnesslayer._AbstractUser#getUserhandler <em>Userhandler</em>}</li>
 *   <li>{@link RootElement.Buissnesslayer._AbstractUser#getAddress <em>Address</em>}</li>
 * </ul>
 *
 * @see RootElement.Buissnesslayer.BuissnesslayerPackage#get_AbstractUser()
...
public interface _AbstractUser extends EObject {
	 ...
	 * @see #setName(char)
	 * @see RootElement.Buissnesslayer.BuissnesslayerPackage#get_AbstractUser_Name()
	...
	/**
	 * Sets the value of the '{@link RootElement.Buissnesslayer._AbstractUser#getName <em>Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setEmail(char)
	 * @see RootElement.Buissnesslayer.BuissnesslayerPackage#get_AbstractUser_Email()
	 * @model required="true" ordered="false"
	 * @generated
	 */
	char getEmail();
	...
	/**
	 * Sets the value of the '{@link RootElement.Buissnesslayer._AbstractUser#getEmail <em>Email</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see RootElement.Buissnesslayer.BuissnesslayerPackage#get_AbstractUser_BookingHandler()
	 * @model required="true" ordered="false"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link RootElement.Buissnesslayer._AbstractUser#getBookingHandler <em>Booking Handler</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see RootElement.Buissnesslayer.BuissnesslayerPackage#get_AbstractUser_Logincontroller()
	 * @model required="true" ordered="false"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link RootElement.Buissnesslayer._AbstractUser#getLogincontroller <em>Logincontroller</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see RootElement.Buissnesslayer.BuissnesslayerPackage#get_AbstractUser_Userhandler()
	 * @model required="true" ordered="false"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link RootElement.Buissnesslayer._AbstractUser#getUserhandler <em>Userhandler</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see RootElement.Buissnesslayer.BuissnesslayerPackage#get_AbstractUser_Address()
	 * @model required="true" ordered="false"
	 * @generated
	 */
	Address getAddress();
	...
	/**
	 * Sets the value of the '{@link RootElement.Buissnesslayer._AbstractUser#getAddress <em>Address</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
